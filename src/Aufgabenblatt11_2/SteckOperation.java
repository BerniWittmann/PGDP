...
public enum SteckOperation {
  ...
  LDH(OpCodeCounter.opCodeCounter++, ImmediateType.Unsigned),
  STH(OpCodeCounter.opCodeCounter++, ImmediateType.Unsigned),
  ALLOCH(OpCodeCounter.opCodeCounter++, ImmediateType.Unsigned);
